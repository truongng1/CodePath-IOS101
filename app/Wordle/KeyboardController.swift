...
class KeyboardController: NSObject,
  ...
  func collectionView(_ collectionView: UICollectionView,
    ...
    let keyString = keyboardRows[indexPath.section][indexPath.row]
    cell.configure(with: keyString)
    // Tell the cell what to do when tapped
    cell.didSelectString = { string in
